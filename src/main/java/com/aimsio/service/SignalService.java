...
public class SignalService {
	...
	public Map<String, Number> getSignalsForGivenAssetUNAndStatus(String status, String assetUN) {
		List<Map<String, Object>> signalsForGivenAssetUNAndStatus = jdbcTemplate
				.queryForList(RETRIEVE_SIGNALS_BY_STATUS_ASSETUN, assetUN, status);
	...
	public Map<String, Map<String, Number>> getSignalsForGivenAssetUN(String assetUN) {
		List<Map<String, Object>> signalsForGivenAssetUNAndStatus = jdbcTemplate
				.queryForList(RETRIEVE_SIGNALS_BY_ASSETUN, assetUN);
		...
		for (Map<String, Object> map : signalsForGivenAssetUNAndStatus) {
			...
			signalStatusMap.get(map.get("status")).put(((java.sql.Date) map.get("entryDate")).toString(),
					(Long) map.get("cnt"));
		}
